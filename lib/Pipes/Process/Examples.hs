-- | Examples using "Pipes.Process".  You will want to look at the
...
-- find the source at
--
-- <https://github.com/massysett/pipes-process/blob/master/lib/Pipes/Process/Examples.hs>

module Pipes.Process.Examples where
